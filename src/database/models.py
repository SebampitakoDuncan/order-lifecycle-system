...
class Payment(Base):
    __tablename__ = 'trellis_payments'
    
    payment_id = Column(String(255), primary_key=True)
    order_id = Column(String(255), ForeignKey('trellis_orders.id'), nullable=False)
